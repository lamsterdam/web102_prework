...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        newDiv.innerHTML = `<img src=${games[i].img} class="game-img"> ${games[i].name} ${games[i].description}`
...
let displayStr = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, 
${numUnfundedGames} ${numUnfundedGames > 1 ? 'games remain' : 'game remains'} unfunded. We need your help to fund these amazing games!`
